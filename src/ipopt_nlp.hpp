 ...
 */
#ifndef MADOPT_IPOPT_NLP_H
#define MADOPT_IPOPT_NLP_H
...
class IpoptUserClass : public Ipopt::TNLP {
public:
    IpoptUserClass(Model* solver):solver(solver){}
...
//  virtual bool get_variables_types(Index n, VarType* var_types); 
